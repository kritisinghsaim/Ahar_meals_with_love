...
public partial class about_us_admin_home_upickupinfo : System.Web.UI.Page
{
    ...
    {
        string qry = "select [ID],[Email],[Uname],[Eventdetail],[venue],[date],[quantity],[status] from upick";
