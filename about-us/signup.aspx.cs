...
public partial class about_us_signup : System.Web.UI.Page
{
    ...
    protected void regbtn_Click(object sender, EventArgs e)
    {
        ...
        string usercheck = "select * from uReg where Email='" + email.Text.ToString() + "'";
        ...
        else
        {
            ...
            string qry = "insert into ureg values('" + email.Text.ToString() + "','" + otp1 + "')";
    ...
    {
        string qry1 = "select * from ureg where Email='" + email.Text.ToString() + "' and OTP='" + otp.Text + "'";
        SqlConnection con = new SqlConnection(constr);
        con.Open();
        ...
        con.Open();
        string qry2 = "insert into uRegistration (Email) values ('" + email.Text.ToString() + "')";
        ...
        if (check == 1)
        {
...

            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "redirectJS", " setTimeout(function(){window.location.replace('user_home/chpass.aspx')}, 2000);", true);
