<%@ Page Title="" Language="C#" MasterPageFile="~/about-us/vol_home/uMasterPage.master" AutoEventWireup="true" CodeFile="uprofile.aspx.cs" Inherits="about_us_vol_home_uprofile" %>
...
<%--										<div class="control-group">
                                        ...
                                        <div class="control-group">
											<label class="control-label" for="basicinput">availablity day</label>
											<div class="controls">
												<asp:DropDownList ID="availble" CssClass="form-control" runat="server">
                                                    <asp:ListItem Text="Full Week" />
                                                    <asp:ListItem Text="half week" />
                                                    <asp:ListItem Text="Only in Sunday" />
                                                </asp:DropDownList>
											</div>
										</div>
                                        <div class="control-group">
