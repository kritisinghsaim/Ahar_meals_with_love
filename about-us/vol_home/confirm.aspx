<%@ Page Title="" Language="C#" MasterPageFile="~/about-us/vol_home/uMasterPage.master" AutoEventWireup="true" CodeFile="confirm.aspx.cs" Inherits="about_us_vol_home_confirm" %>
                        ...
                        <div class="container form-horizontal row-fluid">
                            ...
                            <div class="control-group">
                                <div class="control-label">
                                    <asp:Label ID="Label1" runat="server" Text="vol Name" CssClass="control-label"></asp:Label>
                                    </div>
                                    <div class="controls">
                            <asp:Label ID="uname" runat="server" Text="vol Name" CssClass="control-label"></asp:Label>
                               </div>     
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                <div class="control-label">
                                    <asp:Label ID="Label10" runat="server" Text="Available" CssClass="control-label"></asp:Label>
                                    </div>
                                <div class="controls">
                                <asp:Label ID="avail" runat="server" Text="Available" CssClass="control-label"></asp:Label>
                            </div>
                            </div>
