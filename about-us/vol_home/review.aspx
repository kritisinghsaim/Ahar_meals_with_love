<%@ Page Title="" Language="C#" MasterPageFile="~/about-us/vol_home/uMasterPage.master" AutoEventWireup="true" CodeFile="review.aspx.cs" Inherits="about_us_vol_home_review" %>
...
<div class="control-group">
                                <div class="control-label">
                                    <asp:Label ID="Label9" runat="server" Text="Available" CssClass="control-label"></asp:Label>
                                    </div>
<div class="controls">
                                <asp:Label ID="lblavai" runat="server" Text="Available" CssClass="control-label"></asp:Label>
                            </div>
                                 </div>
