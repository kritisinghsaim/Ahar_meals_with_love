...
public partial class about_us_login: System.Web.UI.Page
{
    ...
    protected void btnlogin_Click(object sender, EventArgs e)
    {
        try
        {
            string userlogin = "select * from uRegistration where Email='" + txtemail.Text.ToString().Trim() + "' and Password='" + Encrypt(txtpassword.Text.ToString().Trim(), true) + "'";
            ...
            {//session creation
                ...
                Response.Redirect("user_home/userdashboard.aspx");
            }
            else
            {
