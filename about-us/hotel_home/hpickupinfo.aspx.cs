...
public partial class about_us_hotel_home_hpickupinfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        List<string> rcval = (List<string>)Session["PassMultiVal"];
         ...
         string qry = "select * from hpick where Email='" + rcval[0] + "'"; 
       // string qry = "select  [Eventdetail],[venue],[date],[quantity],[status] from hpick where Email='" + rcval[0] + "'";
