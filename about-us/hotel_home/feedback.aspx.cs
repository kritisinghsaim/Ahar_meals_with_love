...
public partial class about_us_hotel_home_feedback : System.Web.UI.Page

{
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        string qry1 = "select ID from hRegistration where Email='" + rcval[0] + "'";
        ...
        if (Session["PassMultiVal"] != null)
        {
            ...
            try
            {
                ...
                if (i > 0)
                {
                    if(ticket!=0)
                    {
                        Label1.Text = "Successfully submitted! Your Ticket# - "+ticket+". Use this number to check complaint status <a href='#'>here</a>.";
                    }
                    else
                    {
