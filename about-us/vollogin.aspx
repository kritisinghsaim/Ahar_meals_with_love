<%@ Page Title="" Language="C#" MasterPageFile="~/about-us/MasterPage.master" AutoEventWireup="true" CodeFile="vollogin.aspx.cs" Inherits="about_us_vollogin" %>
...
<form runat="server">
   ...
   <asp:TextBox ID="txtpassword" runat="server" placeholder="Your Password" TextMode="Password" ></asp:TextBox> </p><p>
    ...
    <a href="volforgot.aspx">forgot password ! </a>
    </form>
   </div></div>
</asp:Content>
