...
public partial class about_us_user_home_donationinfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //string userselect = "select * from uRegistration 

        string qry = "select * from bdonat where Email='" + rcval[0] + "'";
        //string qry = "select [ID],[Email],[Name], [Gender], [Phone], [Address],[Aadhar],[AreaCode] from uregistration";
