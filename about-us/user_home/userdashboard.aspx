<%@ Page Title="" Language="C#" MasterPageFile="~/about-us/user_home/uMasterPage.master" AutoEventWireup="true" CodeFile="userdashboard.aspx.cs" Inherits="about_us_user_home_Default" %>
                              ...
                              <div class="btn-box-row row-fluid">
                                ...
                                <div class="btn-box-row row-fluid">
                                    <a href="info.aspx" class="btn-box big span4"><i class=" icon-bullhorn"></i><%--<b>65%</b>--%>
                                        ...
                                        <b><p class="text-muted">
                                            Complete User Profile</p></b>
                                    </a><a href="..\donation.aspx" class="btn-box big span4"><i class="icon-money"></i><%--<b>15,152</b>--%>
                                        <b><p class="text-muted">
                                            Donate</p></b>
                                    </a>
                                </div>
                                <div class="btn-box-row row-fluid">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                ...
                                                </a><a href="chpass.aspx" class="btn-box big span4"><i class="icon-key"></i><b><p class="text-muted">Change Password</p> </b> </a>
                                            </div>
                                        </div>
