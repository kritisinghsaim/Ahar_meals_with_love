...
public partial class about_us_user_home_confirm : System.Web.UI.Page
{
    ...
    protected void btncon_Click(object sender, EventArgs e)
    {
        ...
        if (Session["confirm"] != null)
        {
            ...
            try
            {
                ...
                string qry = "update uRegistration set Name='" + rcval[0] + "',Gender='" + rcval[1] + "',DOB='" + rcval[2] + "',Phone='" + rcval[4] + "' ,Address='" + rcval[6] + "', Aadhar='" + rcval[5] + "', AreaCode='" + rcval[7] + "', Image='" + rcval[8] + "' where Email='" + rcval[3] + "'";
